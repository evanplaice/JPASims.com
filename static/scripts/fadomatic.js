...
function thumb_click(num){
clear();
var tx = document.getElementById(num);
tx.style.display = "block";
var full = new Fadomatic(tx, 30,0);
full.fadeIn();
}

function thumb_close(num2){
var tx = document.getElementById(num2);
var hide = new Fadomatic(tx, 30);
hide.fadeOut();
}

function clear(){
var t1 = document.getElementById("t1");
var c1 = new Fadomatic(t1, 5);
c1.hide();
}
